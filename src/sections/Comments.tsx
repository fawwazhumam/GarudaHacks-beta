...
export default function CommentsBar({
  className = "",
  heading = "Garuda Hacks by the numbers",
          ...
          {comments.map((comment, index) => (
            <div
              ...
              className={`flex flex-col gap-4 rounded-xl px-4 border transition-colors ${
                comment.featured
                  ? "bg-[#F9F5FF] border-pink-400"
                  : "bg-[#F9F5FF] border-pink-200 hover:bg-gray-100"
              }`}>
              ...
              <div className="flex items-center justify-between gap-3 py-4 border-t border-pink-400">
                <div className="flex items-center gap-2.5">
                  <div className="w-7 h-7 rounded-full bg-[#F9F5FF] border border-pink-400 shrink-0 flex items-center justify-center">
                    <svg
                      width="12"
                      height="12"
                      viewBox="0 0 12 12"
                ...
                <div className="w-6 h-6 rounded-md bg-[#F9F5FF] border border-pink-400 flex items-center justify-center shrink-0">
                  <svg
                    width="11"
                    height="11"
                    viewBox="0 0 11 11"
