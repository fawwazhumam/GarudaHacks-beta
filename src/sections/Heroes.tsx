    ...
    <section className="w-full ${className}">
      <div className="max-w-[1216px] mx-auto px-5 md:px-8">
        <div className="flex flex-col items-center text-center pt-24 md:pt-32 pb-14 md:pb-20 gap-5 md:gap-6">
          ...
          <p className="font-['Plus_Jakarta_Sans,sans-serif] font-medium text-gray-200 leading-relaxed max-w-[480px]">
            Be part of Indonesia's Largest Hackathon &apos;s Free to use
          </p>
