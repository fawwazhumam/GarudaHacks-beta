...
const navLinks = [
  ...
  { label: "Tracks", hasDropdown: false },
  { label: "FAQ", hasDropdown: false },
  { label: "2025", hasDropdown: false },
];
        ...
        <div className="max-w-[1216px] mx-auto px-6 md:px-8">
          <div className="flex items-center justify-between h-14 md:h-[58px]">
            ...
            <div className="hidden md:flex items-center gap-3">
              <button className="px-6 py-2 text-[16px] font-semibold text-white bg-gray-900 rounded-lg hover:bg-gray-700 transition-colors font-['Plus_Jakarta_Sans',sans-serif]">
                Apply Now
              </button>
            </div>
